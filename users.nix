{ ... }:
{
  users.users = {
    ...
    april = {
      ...
      extraGroups = [];
      openssh.authorizedKeys.keys = [
        "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOBF4P4mA/44Hi9966gD0TiaFA29sA36Qq8yLKwaPMaH _4pr1l@yaptop" "sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIBTGgUYUsIAtcbZBqk5Mq0LH2T5KGFjdjAgNIwUf+/LBAAAABHNzaDo= pilz@framewok" ];
    };
    # Jule
